...
public class Complex implements ComplexMathMethods{
	...
	@Override
	public Complex normalize(){return this.mult(invSqrt(this.real*this.real+this.imag*this.imag));}
	...
	public boolean equals(Object c){
		if(!(c instanceof Complex))throw new IllegalArgumentException("can't compare "+c.getClass()+" and Complex value");
